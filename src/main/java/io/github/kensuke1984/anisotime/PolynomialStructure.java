...
public class PolynomialStructure implements VelocityStructure {
    ...
    public static final PolynomialStructure PREM =
            new PolynomialStructure(io.github.kensuke1984.kibrary.dsmsetup.PolynomialStructure.PREM);
    /**
     * isotropic PREM by Dziewonski &amp; Anderson 1981
     */
    public static final PolynomialStructure ISO_PREM =
            new PolynomialStructure(io.github.kensuke1984.kibrary.dsmsetup.PolynomialStructure.ISO_PREM);
    /**
     * AK135 by Kennett <i>et al</i>. (1995)
     */
    public static final PolynomialStructure AK135 =
            new PolynomialStructure(io.github.kensuke1984.kibrary.dsmsetup.PolynomialStructure.AK135);
    /**
     * Homogeneous structure used for test purposes
     */
    public static final PolynomialStructure HOMOGEN =
            new PolynomialStructure(io.github.kensuke1984.kibrary.dsmsetup.PolynomialStructure.HOMOGEN);
    /**
     * 2019/12/7
     */
    private static final long serialVersionUID = -7292410325252292009L;

    private final io.github.kensuke1984.kibrary.dsmsetup.PolynomialStructure STRUCTURE;
    /*
     * -radius x this is only for computations for bouncing points.
     */
    private final PolynomialFunction RADIUS_SUBTRACTION;

    public PolynomialStructure(io.github.kensuke1984.kibrary.dsmsetup.PolynomialStructure structure) {
    ...
    private io.github.kensuke1984.kibrary.dsmsetup.PolynomialStructure checkBoundaries(
            io.github.kensuke1984.kibrary.dsmsetup.PolynomialStructure structure) {
        ...
        io.github.kensuke1984.kibrary.dsmsetup.PolynomialStructure newStructure = structure;
    ...
    public PolynomialStructure(Path path) throws IOException {
        this(new io.github.kensuke1984.kibrary.dsmsetup.PolynomialStructure(path));
    }
