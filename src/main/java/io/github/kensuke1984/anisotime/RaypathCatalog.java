...
public class RaypathCatalog implements Serializable {
    ...
    private static Path downloadCatalogZip() throws IOException {
        ...
        FileAid.download(website, zipPath, true);
        try {
            if (!PIAC_SHA256.equals(GadgetAid.checksum(zipPath, "SHA-256")))
    ...
    private static void extractInShare() throws IOException {
        ...
        FileAid.extractZip(zipPath, piacTemp);
        ...
        if (Objects.isNull(PREM)) synchronized (LOCK_PREM) {
            if (Objects.isNull(PREM)) {
                try {
                    ...
                    PREM = read(PREM_PATH);
                    System.err.println(" in " + GadgetAid.toTimeString(System.nanoTime() - t));
                } catch (Exception e) {
                    try {
...
//                return EMPTY_RAYPATH;
    ...
    private void catalogOfBounceWaves() {
        ...
        System.err.println(
                "\rCreating catalogs for bouncing waves done in " + GadgetAid.toTimeString(System.nanoTime() - t));
    }
    ...
    private void catalogOfReflections() {
        ...
        System.err
                .println("\rCatalogs for boundaries are computed in " + GadgetAid.toTimeString(System.nanoTime() - t));
    }
    ...
    private void create() {
        ...
        computeDiffraction();
        System.err.println("A catalog was made in " + GadgetAid.toTimeString(System.nanoTime() - time));
    }
