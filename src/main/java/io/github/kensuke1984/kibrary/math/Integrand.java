...
public final class Integrand {
     ...
     *
     * @param h where integral interval is 0 &rarr; 2h
     * @param y f(h), f(2h) for the approximation
     * @return value by 1
     ...
     *
     * @param h where integral interval is 0 &rarr; 3h
     * @param y f(h), f(2h), f(3h) for the approximation
     * @return value by 2
