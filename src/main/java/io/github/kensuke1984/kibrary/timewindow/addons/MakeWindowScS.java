...
//		timeBefore = 10; // 10 for spectral amplitudes
		...
		Path outpath = workdir.resolve("selectedTimewindow_ScS" + GadgetAid.getTemporaryString() + ".dat");
		
		Set<TimewindowData> infoSetScStight = new HashSet<>();
		Path outpathTight = workdir.resolve("selectedTimewindow_ScStight" + GadgetAid.getTemporaryString() + ".dat");
		
		Set<TimewindowData> infoSetScd = new HashSet<>();
		Path outpathScd = workdir.resolve("selectedTimewindow_Scd" + GadgetAid.getTemporaryString() + ".dat");
		
		Set<TimewindowData> infoSet_noSelection = new HashSet<>();
		Path outpath_noSelection = workdir.resolve("timewindow_ScS" + GadgetAid.getTemporaryString() + ".dat");
