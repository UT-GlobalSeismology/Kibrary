...
public enum GnuplotColorName {
    ...
    dark_gray, // #a0a0a0 = 160 160 160
    dark_grey, // #a0a0a0 = 160 160 160

    red, // #ff0000 = 255 0 0
    web_green, // #00c000 = 0 192 0
    web_blue, // # 0080ff = 0 128 255
    dark_magenta, // #c000ff = 192 0 255
    dark_cyan, // #00eeee = 0 238 238
    dark_orange, // #c04000 = 192 64 0
    dark_yellow, // #c8c800 = 200 200 0
    royalblue, // #4169e1 = 65 105 225
    goldenrod, // #ffc020 = 255 192 32
    dart_spring_green, // #008040 = 0 128 64
    purple,// #c080ff = 192 128 255
    steel_blue, // #306080 = 48 96 128
    dark_red, // #8b0000 = 139 0 0
    dark_chartreuse, // #408000 = 64 128 0
    ...
    light_salmon, // #ffa070 = 255 160 112
