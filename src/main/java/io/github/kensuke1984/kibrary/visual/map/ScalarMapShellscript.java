    ...
    static void writeCpMaster(Path outputPath) throws IOException {
        try (PrintWriter pw = new PrintWriter(Files.newBufferedWriter(outputPath))) {
            ...
            case 1:
                ...
                pw.println("0.25 207 243 243   0.75 207 243 243");
                pw.println("0.75 174 235 238   1.25 174 235 238");
                pw.println("1.25 139 217 232   1.75 139 217 232");
                pw.println("1.75 112 191 225   2.25 112 191 225");
                pw.println("2.25  79 157 199   2.75  79 157 199");
