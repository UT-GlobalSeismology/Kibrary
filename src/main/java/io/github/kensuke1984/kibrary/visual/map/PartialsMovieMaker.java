...
//        amplification = property.parseDouble("amplification", "1e29");
                    ...
                    for (String observerName : tendObservers) {
                        ...
                        for (double startTime : startTimes) {
                            ...
                            for (int i = 0; i < npts; i++) {
                                ...
                                createCrossSection(discreteMap, variableType, outSnapshotPath);
                            }
                        }
                    }
                }
    ...
    private void createCrossSection(Map<FullPosition, Double> discreteMap, VariableType variable, Path outPath) throws IOException {
...
//        }
        ...
        writeMakeMap(distance, lowerRadius, upperRadius, modelFileNameRoot, gmtPath, variable);
    }
...
//            }
    ...
    private void writeMakeMap(double sectionDistance, double lowerRadius, double upperRadius, String modelFileNameRoot, Path outputPath, VariableType variable) throws IOException {
