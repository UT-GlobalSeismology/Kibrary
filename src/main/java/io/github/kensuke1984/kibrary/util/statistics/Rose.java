...
public class Rose {
    ...
    public static void main(String[] args) throws IOException {
        ...
        List<BasicID> ids = BasicIDFile.read(waveformIDPath, false);
        ...
        for (BasicID id : ids) {
            CrossSectionLine line = new CrossSectionLine(id.getGlobalCMTID().getEventData().getCmtPosition().toHorizontalPosition(), id.getObserver().getPosition(), deltaThetaRad);
