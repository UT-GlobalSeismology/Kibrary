...
public class WaveformClustering {
    ...
    public static void main(String[] args) {
        ...
        try {
            timewindows = TimewindowDataFile.read(timewindowPath).stream()
    ...
    public WaveformClustering(List<TimewindowData> timewindows, Path sacpath, double cutHeight) {
    ...
    public WaveformClustering(List<TimewindowData> timewindows, Path sacpath) {
        this.waveforms = new RealVector[timewindows.size()];
        setWaveforms(timewindows, sacpath);
        datasamplinghz = 20;
        this.cutHeight = 0.02;
    ...
    private void setWaveforms(List<TimewindowData> timewindows, Path sacpath) {
        for (int i = 0; i < timewindows.size(); i++) {
            TimewindowData window = timewindows.get(i);
            String sacnameString = window.getGlobalCMTID() + "/" + window.getObserver().getName() + "." + window.getGlobalCMTID()
