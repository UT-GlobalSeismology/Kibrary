...
public class Measurement {
    ...
    public Measurement(TimewindowData timewindow, double timeshift, double amplitudeRation, double crosscorrelationAtBestShift, double sn0, double sn1) {
    ...
    public Measurement(TimewindowData timewindow, double timeshift, double amplitudeRation, double crosscorrelationAtBestShift) {
        this.timewindow = timewindow;
        this.timeshift = timeshift;
        this.amplitudeRatio = amplitudeRation;
        this.crosscorrelationAtBestShift = crosscorrelationAtBestShift;
