...
public class RecordSectionWindow {
    ...
    public RecordSectionWindow(List<TimewindowData> timewindows, Path sacpath) {
        dataset = createDataset(timewindows, sacpath);
    }

    public RecordSectionWindow(List<TimewindowData> timewindows, List<PolarizedShift> polarizedShifts, Path sacpath) {
    ...
    private XYSeriesCollection createDataset(List<TimewindowData> timewindows, List<PolarizedShift> polarizedShifts, Path sacpath) {
    ...
    private XYSeriesCollection createDataset(List<TimewindowData> timewindows, Path sacpath) {
        XYSeriesCollection dataset = new XYSeriesCollection();
